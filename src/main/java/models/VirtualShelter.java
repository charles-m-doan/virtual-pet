		...
		for (VirtualPet pet : pets) {
			...
			if (pet.getHealth() <= 0) {
				...
				if (value < 3) {
					...
					System.out.println(pet.getName() + " the " + pet.getType() + " died from neglect.");
				} else {
					System.out.println("Warning: " + pet.getName() + " the " + pet.getType()
							+ " is feeling terrible and is on the verge of death!");
				}
			}
		}
	}
